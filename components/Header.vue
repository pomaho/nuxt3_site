        ...
        <div class="col-sm-12">
          <div class="main-menu">
            <div class="menu-left">
              ...
              <div class="brand-logo"><a href="index.html"><img src="../assets/images/icon/layout3/logo.png"
                    class="img-fluid lazyload" alt=""></a></div>
            </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col mega-box">
                                <div class="link-section">
                                  ...
                                  <div class="menu-content">
                                    <ul>
                                      <li><a target="_blank" href="../email-template/welcome.html">welcome</a></li>
                                      <li><a target="_blank"
                                      ...
                                      <li><a target="_blank" href="../email-template/offer.html">offer</a></li>
                                      <li><a target="_blank" href="../email-template/offer-2.html">offer 2</a></li>
                              ...
                              <div class="col mega-box">
                                <div class="link-section">
                                  ...
                                  <div class="menu-content">
                                    <ul>
                                      <li><a target="_blank" href="../email-template/black-friday.html">black friday</a>
                                      </li>
                                      <li><a target="_blank" href="../email-template/christmas.html">christmas</a></li>
                                      <li><a target="_blank" href="../email-template/cyber-monday.html">cyber-monday</a>
                                      </li>
                                      <li><a target="_blank" href="../email-template/flash-sale.html">flash sale</a>
                                      </li>
                              ...
                              <div class="col mega-box">
                                <div class="link-section">
                                  ...
                                  <div class="menu-content">
                                    <ul>
                                      <li><a href="index.html">bottom<i class="ms-2 fa fa-bolt icon-trend"
                                ...
                                <div class="link-section">
                                  ...
                                  <div class="menu-content">
                                    <ul>
                                      ...
                                      <li><a href="index.html">exit<i class="ms-2 fa fa-bolt icon-trend"
                                            aria-hidden="true"></i></a></li>
                  ...
                  <ul>
                    <li class="onhover-div mobile-search">
                      <div><img src="../assets/images/icon/search.png" onclick="openSearch()"
                          class="img-fluid lazyload" alt=""> <i class="ti-search" onclick="openSearch()"></i>
                      </div>
                    ...
                    <li class="onhover-div mobile-setting">
                      <div><img src="../assets/images/icon/setting.png" class="img-fluid  lazyload" alt=""> <i
                    ...
                    <li class="onhover-div mobile-cart">
                      <div><img src="../assets/images/icon/cart.png" class="img-fluid lazyload" alt=""> <i
                          class="ti-shopping-cart"></i></div>
                      <ul class="show-div shopping-cart">
                        <li>
                          <div class="media">
                            <a href="#"><img class="me-3" src="../assets/images/fashion/product/1.jpg"
                        ...
                        <li>
                          <div class="media">
                            <a href="#"><img class="me-3" src="../assets/images/fashion/product/2.jpg"
                                alt="Generic placeholder image"></a>
                            <div class="media-body">
                              <a href="#">
                                <h4>item name</h4>
